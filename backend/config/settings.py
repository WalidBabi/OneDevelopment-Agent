...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'onedevelopment_agent'),
        'USER': os.getenv('DB_USER', 'onedevelopment'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'postgresLuna2024'),
...
CORS_ALLOW_ALL_ORIGINS = True  # Quick fix for CORS issues
