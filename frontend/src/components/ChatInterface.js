...
const ChatInterface = () => {
  ...
  // Initialize session and fetch suggested questions
  useEffect(() => {
    ...
    // Set up rotating suggested questions (every 15 seconds)
        ...
        {messages.length === 0 ? (
          <div className="welcome-section">
            <div className="welcome-avatar">
              <img src="/Nova.png" alt="Nova" className="welcome-avatar-image" />
            </div>
            <h2>Welcome! I'm Nova 🌟</h2>
            <p>
              ...
              <div key={message.id} className={`message ${message.type}`}>
                {message.type === 'assistant' && (
                  <div className="message-avatar">
                    <img src="/Nova.png" alt="Nova" className="avatar-image" />
                  </div>
                )}
